...
window.SITE_CONTENT = {
  ...
  "index": {
    ...
    "heroSub": "17 — erste eigene Saison im Aufbau",
    "heroText": "Ein BMW E30 von 1990, 2.5 Liter, Hinterradantrieb. Als halbfertiges Bergrennen-Auto gekauft und seither im Umbau — gefahren wird damit Bergrennen und Rallye.",
    "heroBtn1": "Partner werden",
    "heroBtn2": "Das Auto kennenlernen",
    "nextEvent": "—",
    "nextDate": "—",
    "nextDiscipline": "—",
    "nextSeries": "—",
  ...
  "timeline": [
    {
      "year": "2025",
      "title": "Rental-Karting im Schwarzwaldcup",
      "text": "Erste echte Rennen mit Startaufstellung, Zeitnahme und Gegnern auf der Strecke — die günstigste Art, Renndistanz zu sammeln."
    },
    {
      "year": "2023",
      "title": "Angefangen mit Rallye-Simracing",
      "text": "Am Simulator, Stage für Stage: Aufschrieb lesen, Bremspunkte finden und gelernt, was ein Auto macht — quer durch alle Fahrzeugtypen, von Front- bis Allradantrieb."
    }
  ],
  "packages": [
    {
      "title": "Klebefläche am Auto",
      "kind": "Geldbetrag",
      "price": "Nach Fläche",
      "lead": false,
      "items": [
        "Aufkleber an der Fläche Ihrer Wahl — Kotflügel, Tür, Seitenteil, Schweller oder Scheibe",
        "Logo auf dieser Website und am Anhänger",
        "Nennung in den Social-Posts jedes Renntags",
        "Kurzer Bericht nach der Saison, was daraus geworden ist"
      ]
    },
    {
      "title": "Material statt Geld",
      "kind": "Sachleistung",
      "price": "Gegenwert zählt",
      "lead": true,
      "items": [
        "Räder, Reifen, Bremsen, Öl, Lack, Transport oder Stunden in der Werkstatt",
        "Der Gegenwert wird angerechnet wie ein Geldbetrag — die Fläche am Auto richtet sich danach",
        "Ihr Produkt im Einsatz: Fotos und Videos vom Renntag, nicht aus dem Katalog",
        "Ehrlicher Erfahrungsbericht, den Sie selbst weiterverwenden dürfen",
        "Auch als Teilbetrag neben einer Geldbeteiligung möglich"
      ]
    },
    {
      "title": "Hauptpartner",
      ...
      "lead": false,
      "items": [
        "Ihr Name im Teamnamen",
        "Lackierung rund um Ihre Marke gestaltet, beste Flächen auf Haube und Dach",
        "Das Auto für einen Firmenanlass oder Tag der offenen Tür",
        "Zutritt ins Fahrerlager an jedem Renntag",
        "Exklusiv in Ihrer Branche"
      ]
    }
  ],
  "partners": [
